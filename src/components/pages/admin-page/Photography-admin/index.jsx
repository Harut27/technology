...
class PhotographyForAdmin extends Component{
    ...
    render(){
        ...
        return(
            <div className="admin-carts">
                ...
                <NewPost path="/photography"/>

                {
                    tvsData.map((tv,index)=>{
                        return(
                            <div className="admin-cart" key={index}>
                                <NewsCard size="300x300" image={tv.src} hasBg={true}
                                title={tv.title}
                                link={`/posts/${tv.id}/info`}
...
export default PhotographyForAdmin;